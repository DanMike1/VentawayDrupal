...
class __TwigTemplate_9b7870c1dfc26e8a07e20d72d016f4ae1217e059b207ecf22d6caa9139ba5c7d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"slider-text\">
      <ul class=\"js-rotating\">
        ...
        if ((($context["slider_code"] ?? null) != "")) {
            // line 8
            echo "          ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(strip_tags($this->sandbox->ensureToStringAllowed(($context["slider_code"] ?? null), 8, $this->source), "<ol>,<ul>,<li>,<p>,<a>,<img>,<video>,<h1>,<h2>,<h3>,<h4>,<h5>,<h6>,<em>,<strong>,<br>,<i>,<button>,<mark>,<hr>"));
            echo "
        ";
        } else {
            // line 10
...
";
    ...
    {
        return new Source("", "@ruhi/template-parts/slider.html.twig", "C:\\xampp\\htdocs\\ventawaydrupal\\themes\\ruhi\\templates\\template-parts\\slider.html.twig");
    }
